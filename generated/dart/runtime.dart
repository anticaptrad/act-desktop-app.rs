...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final actDesktopAppBind = pick(['ACT_DESKTOP_APP_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (actDesktopAppBind != null) out['ACT_DESKTOP_APP_BIND'] = actDesktopAppBind;
  return out;
}
